...
Call log:
  - waiting for locator('header').getByText('Sign in')
                  ...
                  - generic [ref=e75]:
                    ...
                    - generic [ref=e79]:
                      ...
                      - link "places that make a discount on a drink in your cup" [ref=e81] [cursor=pointer]:
                        - /url: "#/places"
              - generic [ref=e83]:
                - heading "Eco news" [level=2] [ref=e84]
                - link "link to eco-news page" [ref=e87] [cursor=pointer]:
                  - /url: "#/greenCity/news"
                  - text: Read all news
                  - img [ref=e88]
              - generic [ref=e92]:
                - img "Scan this QR-code To access the mobile version of the app" [ref=e94]
                - generic [ref=e95]:
                  - heading "Receive interesting news" [level=2] [ref=e96]
                  - paragraph [ref=e97]: Subscribe for our newsletter and always be up to date with news and updates
                  - generic [ref=e98]:
                    - textbox "Enter your email" [ref=e99]
                    - button "Subscribe!" [ref=e100] [cursor=pointer]
          - contentinfo [ref=e102]:
            - generic [ref=e103]:
              - generic [ref=e104]:
                - link "GreenCity home" [ref=e106] [cursor=pointer]:
                  - /url: "#/greenCity"
                  - img "GreenCity home" [ref=e107]
                - navigation [ref=e108]:
                  - menu [ref=e109]:
                    - listitem [ref=e110]:
                      - link "Eco news" [ref=e111] [cursor=pointer]:
                        - /url: "#/greenCity/news"
                    - listitem [ref=e112]:
                      - link "Events" [ref=e113] [cursor=pointer]:
                        - /url: "#/greenCity/events"
                    - listitem [ref=e114]:
                      - link "Places" [ref=e115] [cursor=pointer]:
                        - /url: "#/greenCity/places"
                    - listitem [ref=e116]:
                      - link "About Us" [ref=e117] [cursor=pointer]:
                        - /url: "#/greenCity/about"
                    - listitem [ref=e118]:
                      - link "My Space" [ref=e119] [cursor=pointer]:
                        - /url: "#/greenCity/profile/not_signed-in"
                    - listitem [ref=e120]:
                      - link "UBS Courier" [ref=e121] [cursor=pointer]:
                        - /url: "#/ubs"
                  - menu [ref=e122]:
                    - listitem [ref=e123]:
                      - paragraph [ref=e124]: Follow us
                    - listitem [ref=e125]:
                      - link "Twitter link" [ref=e126] [cursor=pointer]:
                        - /url: "#"
                        - img "Twitter link" [ref=e127]
                      - link "LinkedIn link" [ref=e128] [cursor=pointer]:
                        - /url: "#"
                        - img "LinkedIn link" [ref=e129]
                      - link "Facebook link" [ref=e130] [cursor=pointer]:
                        - /url: "#"
                        - img "Facebook link" [ref=e131]
                      - link "Instagram link" [ref=e132] [cursor=pointer]:
                        - /url: "#"
                        - img "Instagram link" [ref=e133]
                      - link "YouTube link" [ref=e134] [cursor=pointer]:
                        - /url: "#"
                        - img "YouTube link" [ref=e135]
              - generic [ref=e136]: © Copyright 2026. Green City.
    - button "chat" [ref=e137] [cursor=pointer]:
      - img "chat" [ref=e138]
  - generic [ref=e139]: Welcome to the search window
```
...
```ts
  ...
  11 |     
  12 |     // ТУТ ВИПРАВЛЕНО: шукаємо елемент суто за текстом "Sign in" всередині хедера
  13 |     this.loginButton = page.locator('header').getByText('Sign in');
  14 |   }
  15 | 
  16 |   async navigate() {
  ...
  19 | 
  20 |   async clickLogin() {
  21 |     // Чекаємо, поки елемент просто з'явиться в структурі (DOM)
  22 |     await this.loginButton.waitFor({ state: 'attached', timeout: 5000 });
  23 |     
  24 |     // Клікаємо примусово, ігноруючи перевірки браузера на видимість
> 25 |     await this.loginButton.click({ force: true });
     |                            ^ Error: locator.click: Element is not visible
  26 |   }
  27 | }
```