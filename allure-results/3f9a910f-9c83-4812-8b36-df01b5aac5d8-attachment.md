...
```ts
  ...
  11 |     
  12 |     // ТУТ ВИПРАВЛЕНО: використовуємо точний клас кнопки з логів сайту GreenCity
  13 |     this.loginButton = page.locator('.header_sign-in-link');
  14 |   }
  15 | 
  16 |   async navigate() {
  ...
  19 | 
  20 |   async clickLogin() {
  21 |     // Чекаємо, поки кнопка стане доступною для кліку, і тиснемо
