...
Call log:
  - waiting for locator('header .header_user-name, .ubs-header-sing-in, header li .ng-star-inserted img, header .header_navigation-menu-right-item a, .ubs-user-avatar').first()
...
```ts
  ...
  9  |     this.page = page;
  10 |     this.signInButton = page.locator([
  11 |       'header .header_user-name',
  12 |       '.ubs-header-sing-in',
  13 |       'header li .ng-star-inserted img',
  14 |       'header .header_navigation-menu-right-item a',
  15 |       '.ubs-user-avatar'
  16 |     ].join(', ')).first();
  17 |   }
  18 |   async clickSignInButton(): Promise<void> {
  19 |     await allure.step('Click Sign In button in header', async () => {
