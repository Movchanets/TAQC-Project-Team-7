...
Call log:
  - waiting for locator('input#email, input[name="email"], input[type="email"]') to be visible
...
```ts
  ...
  7  |     return this.page.locator('input#email, input[name="email"], input[type="email"]'); 
  8  |   }
  9  |   
  10 |   private get passwordInput() { 
  11 |     return this.page.locator('input#password, input[name="password"], input[type="password"]'); 
  12 |   }
  13 |   
  14 |   private get submitButton() { 
  15 |     return this.page.locator('button[type="submit"], button.is-submit'); 
  16 |   }
  17 |   
...
> 25 |       await this.emailInput.waitFor({ state: 'visible', timeout: 15000 });
  ...
  35 |       await expect(this.errorMessage).toBeVisible({ timeout: 15000 });
  36 |     });
  37 |   }
  38 | }
```